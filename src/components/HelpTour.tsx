...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    content: (
      <>
        ...
        <div>
          🎬 Watch the <a href="https://youtu.be/DeOrSrbVILY?si=QfmlCPebyw14agCP" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)', textDecoration: 'none', fontWeight: 600 }}>calibration demo video</a> to see it in action!
        </div>
      </>
    ),
    placement: 'center'
  ...
  },
  {
    ...
    content: (
      <>
        <div style={{ marginBottom: '10px', fontWeight: 600, color: 'var(--accent-primary)' }}>
    ...
    <>
      ...
      >
        <div className="tour-popover-header">
          ...
          <button className="btn-tour-skip" onClick={handleSkip} title="Exit Tour" style={{ background: 'transparent', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: '14px' }}>
            ✕
          </button>
        </div>
